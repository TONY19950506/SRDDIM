...
import sys
sys.path.append('C:\\Users\\Tony\\Desktop\\SRDDIM')         # 改
...
from utils_self.indexed_datasets import IndexedDatasetBuilder
from utils_self.matlab_resize import imresize
...
if __name__ == '__main__':
    ...
    train_img_list = []
    train_img_list += sorted(glob.glob('data/raw/DIV2K/difficult_94804_48994/*.jpg'))
    test_img_list = sorted(glob.glob('data/raw/DIV2K/set_goal_big_to_small_64_64/*.jpg'))
