...
from utils_self.indexed_datasets import IndexedDataset
...
class SRDataSet(Dataset):          
    ...
    def __getitem__(self, index):
        ...
        img_hr = self.pre_process(img_hr)  
        img_hr = np.asarray(img_hr)  
        img_lr = imresize(img_hr, 1 / hparams['sr_scale'], method=hparams['data_interp'])  
