...
from utils_self.dataset import SRDataSet
...
class CustomRotation:
    def __init__(self, angle, resample=Image.BICUBIC):
        self.angle = angle
        self.resample = resample

    def __call__(self, img):
        return img.rotate(self.angle, resample=self.resample)
...
class Df2kDataSet(SRDataSet):
    def __init__(self, prefix='train'):
        ...
        self.data_aug_transforms = transforms.Compose([
            ...
            CustomRotation(20, resample=Image.BICUBIC),  
